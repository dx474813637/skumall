...
<template>
	...
	<div class="u-p-20 box">
		...
		<el-row :gutter="10">
			<el-col :span="5">
				<div class="grid-content label">商品</div>
			</el-col>
			<el-col :span="19">
		...
		<el-row :gutter="10">
			<el-col :span="5">
				<div class="grid-content label">规格</div>
			</el-col>
			<el-col :span="19">
				<div class="grid-content content">{{ list.specs }}</div>
			</el-col>
		</el-row>
		<el-row :gutter="10">
			<el-col :span="5">
				<div class="grid-content label">数量</div>
			</el-col>
			<el-col :span="19">
				<div class="grid-content content">{{ list.num }}</div>
			</el-col>
		</el-row>
		<el-row :gutter="10">
			<el-col :span="5">
				<div class="grid-content label">总价</div>
			</el-col>
			<el-col :span="19">
				<div class="grid-content content u-flex u-flex-items-center">
					<el-statistic :precision="2" :value="list.price" value-style="font-size: 16px" />
		...
		<el-row :gutter="10">
			...
			<el-col :span="19">
				<div class="grid-content content">
					<el-text type="danger" v-if="list.zt == '6'">{{ $filters.order_new_zt(list.zt) }}</el-text>
					<el-text type="success" v-else-if="list.zt == '3' || list.zt == '4'" >{{ $filters.order_new_zt(list.zt) }}</el-text>
					<el-text type="warning" v-else >{{ $filters.order_new_zt(list.zt) }}</el-text>
				</div>
			</el-col>
		</el-row> 
		<el-row :gutter="10">
		...
		<el-row :gutter="10">
			...
			<el-col :span="19" class="u-flex">
				<div class="item u-m-r-10" v-show="list.zt == 0 && login == buy_info.login">
					<el-popconfirm 
						title="支付确认" 
						@confirm="orderBuyBtn"
				...
				<div class="item u-m-r-10" v-show="list.zt == 1 && login == sell_info.login">
					<el-popconfirm 
						title="发货确认" 
	...
	<el-dialog v-model="showEditForm" title="编辑" width="50%" :before-close="handleClose"> 
		<OrderCreateForm
			:origin="list"
...
async function submitSuccess(data) {
