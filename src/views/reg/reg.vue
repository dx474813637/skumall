            ...
            <div class="login-box">
                <div class="login-tabs u-p-10">
					<el-tabs v-model="activeName" class="demo-tabs" >
						<el-tab-pane label="立即注册" name="account_login"></el-tab-pane> 
					</el-tabs>
				</div>
                <div class="login-form-w">
                                    ...
                                    <div class="item">
                                        <el-button type="primary" plain @click="getCodeBtn" :disabled="getCodeDisabled">
                                            <div class="getcode-btn-text" v-show="getCodeDisabled">
                                                <el-countdown format="ss" :value="countValue"
                    ...
                    <div class="login-btn">
                        ...
                        <div class="u-p-t-10">
                            <span>已有账号？</span>
                            <a class="reg-link" href="https://element-plus.org" target="_blank">返回登录</a>
                        </div>
                    </div>
                </div>
